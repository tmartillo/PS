...
get-Viserver @('usssusvc001','ssisusvc0005','ssdsbrvc0001');

function Get-ACVMGuestInventory { 
...
Get-ACMGuestInventory 

Get-ACVMGuestInventory | export-csv -notypeinformation -path c:\temp\VMGuestList.csv