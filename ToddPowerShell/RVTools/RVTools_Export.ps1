#https://github.com/Sneddo/Powershell/blob/master/VMware/RVToolsExport.ps1
...
foreach ($Server in $Servers)
{
   ...
   # Run Export
   . "C:\Program Files (x86)\RobWare\RVTools\RVTools.exe" -u nasa\ssith_adm -p iptwd2qsG -s "$Server.nasa.group.atlascopco.com" -c ExportAll2csv -d "$BasePath\$Server\$Date"
